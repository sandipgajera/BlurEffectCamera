...
public class SvgCircle extends Svg {
    ...
    private static final Matrix f902m;
    private static float od;
    private static final Paint f903p;
    private static final Paint ps;
    private static final Path f904t;
    ...
    public void draw(Canvas c, float w, float h, float dx, float dy, boolean clearMode) {
        ...
        c.drawPath(f904t, f903p);
        c.drawPath(f904t, ps);
        c.restore();
        m805r(Integer.valueOf(3), Integer.valueOf(2), Integer.valueOf(0), Integer.valueOf(1));
        f903p.setColor(Color.parseColor("#FFFFFF"));
        c.restore();
        m805r(new Integer[0]);
        c.restore();
    ...
    private static void m805r(Integer... o) {
        f903p.reset();
        ps.reset();
        if (cf != null) {
