...
*/
   /* public static Collage CreateCollage(int shapeCount, int width, int height, boolean isScrapBook) {
    ...
    public static Collage CreateCollage(final int n, final int n2, final int n3, final boolean b) {
        if (b) {
            return createScrapLaout(n, n2, n3);
        }
        if (n == 1) {
            return new Collage1(n2, n3);
        }
        if (n == 2) {
            return new Collage2(n2, n3);
        }
        if (n == 3) {
            return new Collage3(n2, n3);
        }
        if (n == 4) {
            return new Collage4(n2, n3);
        }
        if (n == 5) {
            return new Collage5(n2, n3);
        }
        if (n == 6) {
            return new Collage6(n2, n3);
        }
        if (n == 7) {
            return new Collage7(n2, n3);
        }
        if (n == 8) {
            return new Collage8(n2, n3);
        }
        if (n == 9) {
            return new Collage9(n2, n3);
        }
        if (n == 10) {
            return new Collage10(n2, n3);
        }
        if (n == 11) {
            return new Collage11(n2, n3);
        }
        if (n == 12) {
            return new Collage12(n2, n3);
        }
        if (n == 13) {
            return new Collage13(n2, n3);
        }
        if (n == 14) {
            return new Collage14(n2, n3);
        }
        if (n == 15) {
            return new Collage15(n2, n3);
        }
        return null;
    }


    public static Collage createScrapLaout(final int n, final int n2, final int n3) {
        final Collage collage = new Collage();
        collage.collageLayoutList = new ArrayList<CollageLayout>();
        final CollageScrapBook collageScrapBook = new CollageScrapBook(n2, n3);
        if (n == 1) {
            collage.collageLayoutList.add(collageScrapBook.collageLayoutList.get(0));
            Collage.scrapBookShapeScale = 0.7f;
        }
        if (n == 2) {
            if (n3 > n2) {
            ...
            if (n == 3) {
                ...
                Collage.scrapBookShapeScale = 0.95f;
                return collage;
            }
            if (n == 4) {
  ...
  /*public static Collage createScrapLaout(int shapeCount, int width, int height) {
	  ...
	  Log.d("SCRAP","scrapLayout collage CALLLLLLLLLLLLLLLL::::::::::::::" + shapeCount);
	  
        Collage collage = new Collage();
        collage.collageLayoutList = new ArrayList();
        CollageScrapBook scrapBook = new CollageScrapBook(width, height);
        if (shapeCount == 1) {
        	 Log.d("SCRAP","shapeCount 111111111111111111111111111 CALLLLLLLLLLLLLLLL::::::::::::::" );
