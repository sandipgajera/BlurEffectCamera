...
public class SvgHeart2 extends Svg {
    ...
    private static final Matrix f794m;
    private static float od;
    private static final Paint f795p;
    private static final Paint ps;
    private static final Path f796t;
    ...
    public void draw(Canvas c, float w, float h, float dx, float dy, boolean clearMode) {
        ...
        c.drawPath(f796t, f795p);
        c.drawPath(f796t, ps);
        c.restore();
        m769r(Integer.valueOf(4), Integer.valueOf(3), Integer.valueOf(1), Integer.valueOf(2));
        f795p.setColor(Color.parseColor("#ff0000"));
        c.save();
        c.translate(129.29f * od, -64.29f * od);
        c.restore();
        m769r(Integer.valueOf(4), Integer.valueOf(3), Integer.valueOf(1), Integer.valueOf(2), Integer.valueOf(0));
        c.restore();
        m769r(Integer.valueOf(4), Integer.valueOf(3), Integer.valueOf(1), Integer.valueOf(2));
        f795p.setColor(Color.parseColor("#ff0000"));
        c.restore();
    ...
    private static void m769r(Integer... o) {
        f795p.reset();
        ps.reset();
        if (cf != null) {
