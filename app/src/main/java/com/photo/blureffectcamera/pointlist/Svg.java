...
public abstract class Svg {
    ...
    static {
        svgList = new Svg[]{new SvgHeart2(), new SvgCircle2(), new SvgClover(), new SvgButterfly(), new SvgMapleLeaf(), new SvgBird(), new SvgBareFoot(), new SvgCloud(), new SvgPaw(), new SvgHexagon(), new SvgDiamond()};
    }
}
