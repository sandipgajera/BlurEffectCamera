...
*/
   /* public static Collage CreateCollage(int shapeCount, int width, int height, boolean isScrapBook) {
    ...
    public static diffShape CreateCollage(final int n, final int n2, final int n3, final boolean b) {
        if (b) {
...
/*    public static Collage createScrapLaout(final int n, final int n2, final int n3) {
    ...
    public static diffShape createScrapLaout(int shapeCount, int width, int height) {
        diffShape collage = new diffShape();
