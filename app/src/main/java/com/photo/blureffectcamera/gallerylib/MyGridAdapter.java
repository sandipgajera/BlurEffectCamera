...
public class MyGridAdapter extends BaseAdapter {
    ...
    static {
        TAG = MyGridAdapter.class.getSimpleName();
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        viewHolder.textPath.setTypeface(type);
        viewHolder.textCount.setTypeface(type);
        viewHolder.selectedCount.setTypeface(type);
