...
public class HdrParameter implements Parcelable {
    public static final Creator<HdrParameter> CREATOR;
    ...
    /* renamed from: com.lyrebirdstudio.hdrlightlib.HdrParameter.1 */
    static class C07331 implements Creator<HdrParameter> {
        C07331() {
        }
    ...
    public HdrParameter() {
        ...
        this.offsetRight = 0;
        this.offsetBottom = 0;
        this.red = new int[AccessibilityNodeInfoCompat.ACTION_NEXT_AT_MOVEMENT_GRANULARITY];
        this.green = new int[AccessibilityNodeInfoCompat.ACTION_NEXT_AT_MOVEMENT_GRANULARITY];
        this.blue = new int[AccessibilityNodeInfoCompat.ACTION_NEXT_AT_MOVEMENT_GRANULARITY];
        this.rgb = new int[AccessibilityNodeInfoCompat.ACTION_NEXT_AT_MOVEMENT_GRANULARITY];
        reset();
    }
    ...
    public void reset() {
        ...
        this.pointsRgb[1] = new MyPoint(AccessibilityNodeInfoCompat.ACTION_NEXT_AT_MOVEMENT_GRANULARITY, AccessibilityNodeInfoCompat.ACTION_NEXT_AT_MOVEMENT_GRANULARITY);
        this.pointsRed = new MyPoint[2];
        this.pointsRed[0] = new MyPoint(0, 0);
        this.pointsRed[1] = new MyPoint(AccessibilityNodeInfoCompat.ACTION_NEXT_AT_MOVEMENT_GRANULARITY, AccessibilityNodeInfoCompat.ACTION_NEXT_AT_MOVEMENT_GRANULARITY);
        this.pointsGreen = new MyPoint[2];
        this.pointsGreen[0] = new MyPoint(0, 0);
        this.pointsGreen[1] = new MyPoint(AccessibilityNodeInfoCompat.ACTION_NEXT_AT_MOVEMENT_GRANULARITY, AccessibilityNodeInfoCompat.ACTION_NEXT_AT_MOVEMENT_GRANULARITY);
        this.pointsBlue = new MyPoint[2];
        this.pointsBlue[0] = new MyPoint(0, 0);
        this.pointsBlue[1] = new MyPoint(AccessibilityNodeInfoCompat.ACTION_NEXT_AT_MOVEMENT_GRANULARITY, AccessibilityNodeInfoCompat.ACTION_NEXT_AT_MOVEMENT_GRANULARITY);
        this.opacity = TextData.defBgAlpha;
        this.saturation = 50;
        this.offsetLeft = 0;
        this.offsetTop = 0;
        this.offsetRight = 0;
