...
public class ColorPickerAdapter extends MyRecylceAdapterBase<RecyclerView.ViewHolder> implements OnClickListener {
    int colorCount;
    int colorDefault;
    private List<Integer> colorList;
    int colorSelected;
    String[] colors;
    MyAdapter.CurrentSquareIndexChangedListener listener;
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private int item;
        MyAdapter.CurrentSquareIndexChangedListener viewHolderListener;

        static {
        }

        public void setCurrentSquareIndexChangedListener(MyAdapter.CurrentSquareIndexChangedListener l) {
    ...
    public ColorPickerAdapter(MyAdapter.CurrentSquareIndexChangedListener l, int cDefault, int cSelected) {
        this.colorCount = 60;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemLayoutView = LayoutInflater.from(parent.getContext()).inflate(R.layout.square_color_recycler_view_item, null);
        ViewHolder viewHolder = new ViewHolder(itemLayoutView);
        viewHolder.setCurrentSquareIndexChangedListener(this.listener);
