...
public class CameraGLSurfaceViewWithBuffer extends CameraGLSurfaceView implements Camera.PreviewCallback {
    ...
    public void resizeTextures() {
        ...
        if (this.mTextureWidth != previewWidth || this.mTextureHeight != previewHeight) {
            ...
            GLES20.glTexImage2D(3553, 0, 6409, this.mTextureWidth, this.mTextureHeight, 0, 6409, 5121, (Buffer) null);
            GLES20.glBindTexture(3553, this.mTextureUV);
            GLES20.glTexImage2D(3553, 0, 6410, this.mTextureWidth / 2, this.mTextureHeight / 2, 0, 6410, 5121, (Buffer) null);
        }
    }
