...
public class TextureRendererBlur extends TextureRendererDrawOrigin {
    ...
    public boolean init(boolean z) {
        ...
        String format = String.format(fshBlur, new Object[]{"sampler2D"});
    ...
    public void resetCacheTexture() {
        ...
        GLES20.glBindTexture(3553, this.mTexCache);
        GLES20.glTexImage2D(3553, 0, 6408, this.mCacheTexWidth, this.mCacheTexHeight, 0, 6408, 5121, (Buffer) null);
