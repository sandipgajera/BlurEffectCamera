...
public class TextureRendererLerpBlur extends TextureRendererDrawOrigin {
    ...
    private void genMipmaps(int i, int i2, int i3) {
        ...
        int i5 = 0;
        while (i5 < i4) {
            GLES20.glBindTexture(3553, this.mTextureDownScale[i5]);
            i5++;
            GLES20.glTexImage2D(3553, 0, 6408, calcMips(i2, i5), calcMips(i3, i5), 0, 6408, 5121, (Buffer) null);
            GLES20.glTexParameteri(3553, 10241, 9729);
            GLES20.glTexParameteri(3553, 10240, 9729);
            GLES20.glTexParameteri(3553, 10242, 33071);
            GLES20.glTexParameteri(3553, 10243, 33071);
        }
        this.mTexViewport = new TextureRenderer.Viewport(0, 0, 512, 512);
    }
