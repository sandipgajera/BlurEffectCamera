...
public abstract class TextureRenderer {
    ...
    public boolean setProgramDefault(String str, String str2, boolean z) {
    ...
    public void defaultInitialize() {
        ...
        FloatBuffer allocate = FloatBuffer.allocate(vertices.length);
        allocate.put(vertices).position(0);
